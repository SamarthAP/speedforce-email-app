    ...
    <div className="flex w-full items-center mr-8">
      <div className="flex flex-row flex-wrap w-full">
        ...
        >
          ...
          <Combobox.Options className="absolute z-10 translate-y-full max-h-60 w-[calc(screen/2)] overflow-y-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
            <Combobox.Option
              value={searchText}
              className={({ active }) =>
                classNames(
